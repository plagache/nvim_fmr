...
clean:
	rm -rf nvim-linux-x86_64 config ~/.local/state/$(APPNAME) ~/.local/share/$(APPNAME) ~/.config/$(APPNAME) ~/.cache/$(APPNAME) && printf "$(LNECLR)\n$(GREEN)[ $(PURPLE)make clean $(GREEN)] was a success$(WHITE)\n\n"
